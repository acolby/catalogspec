...
export function renderItem(instance: SceneItemInstance, implementation: PreactCatalogImplementation, runtime: RuntimeContext) {
  ...
  for (const [slotName, children] of Object.entries(instance.slots ?? {})) {
    slots[slotName] = children.map((child) => renderItem(child, implementation, runtime));
  }
